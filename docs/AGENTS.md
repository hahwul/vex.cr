# AGENTS.md - AI Agent Instructions for the vex.cr Documentation Site

This document is for AI agents editing the vex.cr documentation site under `docs/`.

## Project Overview

This is the documentation companion to [vex.cr](https://github.com/hahwul/vex.cr), a Crystal implementation of the OpenVEX specification. The site is a static site built with [Hwaro](https://github.com/hahwul/hwaro) (Crinja/Jinja2 templates).
...
- Keep terminology consistent with the OpenVEX spec: "document", "statement", "status", "product", "vulnerability", "justification".
- Code samples must be valid Crystal that runs against the latest vex.cr - copy from the repo's `examples/` directory when in doubt.
